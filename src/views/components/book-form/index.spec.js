...
describe('BookForm', () => {
  ...
  describe('Component methods:', () => {
    ...
    describe('#onSubmit', () => {
      ...
      it('should call bookActions#createBook with #state.title', () => {
        const event = {preventDefault: sinon.spy()};

        taskForm.state.title = 'foo';
        taskForm.onSubmit(event);

        expect(taskForm.props.createBook.callCount).toEqual(1);
        expect(taskForm.props.createBook.calledWith('foo')).toEqual(true);
      });
      ...
      it('should not save if title evaluates to an empty string', () => {
        ...
        expect(taskForm.props.createBook.callCount).toBe(0);
