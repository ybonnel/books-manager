...
import { booksReducer, BooksState } from './reducer';
  ...
  describe('booksReducer', () => {
    ...
    describe('CREATE_TASK_SUCCESS', () => {
      it('should prepend new book to list', () => {
        let state = new BooksState({list: new List([task1])});

        let nextState = booksReducer(state, {
    ...
    describe('DELETE_TASK_SUCCESS', () => {
      it('should remove book from list', () => {
        let state = new BooksState({list: new List([task1, task2])});
